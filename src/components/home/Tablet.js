              ...
              <div className="w-full desktop:w-1/2">
                ...
                >
                  ...
                  {!user ? (
                    ...
                    <button
                      className="rounded-full bg-[#d06d52] text-[#fef9f3] px-5 py-3 w-1/3 mt-6 text-lg flex items-center justify-center disabled:opacity-60"
                      type="submit"
                      disabled={loading}
                    >
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg shadow-xl p-8 w-[90%] max-w-md text-center">
            ...
            <button
              ...
              className="mt-6 bg-[#d06d52] text-white px-6 py-2 rounded-full"
            >
              Close
            </button>
          </div>
